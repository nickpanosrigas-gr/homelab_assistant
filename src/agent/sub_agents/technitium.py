...
from src.agent.prompts import TECHNITIUM_SYSTEM_PROMPT
...
def check_technitium(instruction: str) -> str:
    ...
    logs = loki_client.get_container_logs("technitium")
    metrics = influx_client.get_container_metrics("technitiumdns")
